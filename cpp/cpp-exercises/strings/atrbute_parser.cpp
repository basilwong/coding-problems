...
void print_vector_string(std::vector< std::string > vec);

void print_vector_string_2D(std::vector< std::vector< std::string > > vec);

void print_vector_int(std::vector< int > vec);

void print_vector_int_2D(std::vector< std::vector< int > > vec);
// Parses a custom protocol.
void atrbute_parser(){
...
//  print_vector_string(attribute_values[1]);
//  std::cout << attribute_values[1][0] << std::endl;
  current_tag = 1;
...
// Prints the contents of a double vector.
void print_vector_string(std::vector< std::string > vec) {
...
// Printe the contents of a 2D double vector.
void print_vector_string_2D(std::vector< std::vector< std::string > > vec) {
  for (int i = 0; i < vec.size(); i++)
  {
...
// Prints the contents of an unsigned int vector.
void print_vector_int(std::vector< int > vec) {
  for (int i = 0; i < vec.size(); i++) {
    std::cout << vec[i];
    std::cout << " ";
...
// Prints the contents of a 2D unsigned int vector.
void print_vector_int_2D(std::vector< std::vector< int > > vec) {
  for (int i = 0; i < vec.size(); i++) {
    for (int j = 0; j < vec[i].size(); j++)
    {
